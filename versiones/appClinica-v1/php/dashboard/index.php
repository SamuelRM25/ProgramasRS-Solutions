...
verify_session(); // Esta función debe asegurar que $_SESSION['idUsuario'] esté disponible si el usuario está logueado.
...
<div class="d-flex">
    ...
    <div class="sidebar p-3">
        ...
        <ul class="nav nav-pills flex-column mb-auto">
            ...
            <!-- Módulo de Pacientes visible para todos los tipos de usuarios -->
            <li>
            ...
            <?php if ($_SESSION['tipoUsuario'] === 'admin' || $_SESSION['tipoUsuario'] === 'user'): ?>
            <!-- Módulo de Cobros para admin y user -->
            <li>
            ...
            fetch(`../patients/check_patient.php?nombre=${encodeURIComponent(nombre)}&apellido=${encodeURIComponent(apellido)}`)
                ...
                .then(data => {
                    if (data.status === 'success') {
                        ...
                        // Reemplazar alert() con un mensaje en consola o UI
                        console.error('Error: ' + data.message);
                        // Considera mostrar un modal o un elemento de UI para el usuario en lugar de alert()
                    }
                })
                .catch(error => {
