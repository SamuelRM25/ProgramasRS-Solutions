...
verify_session();
$page_title = "Historial de Procedimientos Menores";
    ...
    <div class="main-content flex-grow-1 p-4">
        <div class="container-fluid">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h1 class="h3 mb-0 text-gray-800"><i class="bi bi-clock-history me-2"></i>Historial de Procedimientos</h1>
            ...
            <div class="card shadow-sm mb-4">
                <div class="card-body">
                        ...
                        <table class="table table-striped table-hover">
                            ...
                            <tbody>
                                <?php if (empty($procedimientos)): ?>
                                    <tr>
                                        <td colspan="5" class="text-center py-4">No se encontraron registros de procedimientos</td>
                                    </tr>
                                <?php else: ?>
                                    <?php foreach ($procedimientos as $proc): ?>
                                        <tr>
                                            <td><?php echo htmlspecialchars($proc['nombre_paciente']); ?></td>
                                            <td><?php echo htmlspecialchars($proc['procedimiento']); ?></td>
                                            <td>Q<?php echo number_format($proc['cobro'], 2); ?></td>
                                            <td><?php echo date('d/m/Y', strtotime($proc['fecha_procedimiento'])); ?></td>
                                        </tr>
                                    <?php endforeach; ?>
                                <?php endif; ?>
                            </tbody>
                    ...
                    <div class="text-center text-muted mt-2">
                        Mostrando <?php echo count($procedimientos); ?> de <?php echo $total_registros; ?> registros
                    </div>
                </div>
            </div>
        </div>
