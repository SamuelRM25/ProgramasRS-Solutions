...
<head>
    ...
    <script src="/appGymHD/lib/hikvision/hikfingerprintsdk.js"></script>
</head>
<body>
    <div class="add-client-container">
        ...
        <form id="clientForm" class="client-form">
            ...
            <!-- Nuevo apartado para huella digital -->
            <div class="form-section">
                <h3>Registro de Huella Digital</h3>
                <div class="fingerprint-container">
                    <div class="fingerprint-reader">
                        <div id="fingerprint-placeholder">
                            <i class="fas fa-fingerprint"></i>
                            <span>Coloque su dedo en el lector</span>
                        </div>
                        <div id="fingerprint-status"></div>
                    </div>
                    <div class="fingerprint-actions">
                        <button type="button" id="captureFingerprint" class="fingerprint-btn">
                            <i class="fas fa-fingerprint"></i> Capturar Huella
                        </button>
                        <button type="button" id="resetFingerprint" class="fingerprint-btn reset">
                    ...
                    <div class="membership-card">
                        ...
                        <label for="membership<?php echo $membership['id_membresia']; ?>">
                            ...
                            <div class="membership-details">
                                <span class="duration"><?php echo $membership['duration_membership']; ?> días</span>
                            </div>
                        </label>
                    </div>
                    <?php endforeach; ?>
    ...
    <script src="/appGym/js/fingerprint.js"></script>
</body>
</html>