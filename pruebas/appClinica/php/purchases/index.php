            ...
            <div class="card mb-3">
                <div class="card-body">
                    <div class="input-group">
                        ...
                        <input type="text" id="searchInput" class="form-control" placeholder="Buscar compras...">
                        ...
                        <table class="table table-striped table-hover">
                            ...
                            <tbody id="purchasesTableBody">
                                ...
                                <tr>
                                    ...
                                    <td>Q<?php echo number_format($row['precio_venta'], 2); ?></td>
                                    <td><?php echo date('d/m/Y', strtotime($row['fecha_compra'])); ?></td>
                                    <td>Q<?php echo number_format($row['abono_compra'], 2); ?></td>
                                    <td>Q<?php echo number_format($row['total_compra'], 2); ?></td>
                                    <td>Q<?php echo number_format($saldo, 2); ?></td>
            ...
            <form id="editPurchaseForm" action="update_purchase.php" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" step="0.01" class="form-control" id="edit_precio_venta" name="precio_venta" min="0.01" required>
                    </div>
                    <div class="mb-3">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Función de búsqueda
    function filterPurchases(searchText) {
