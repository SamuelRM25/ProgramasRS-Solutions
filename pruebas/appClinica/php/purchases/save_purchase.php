...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        $stmt = $conn->prepare("INSERT INTO compras (nombre_compra, presentacion_compra, molecula_compra, casa_compra, cantidad_compra, precio_unidad, precio_venta, fecha_compra, abono_compra, total_compra, tipo_pago, estado_compra) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
