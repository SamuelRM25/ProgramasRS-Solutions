    ...
    <div class="main-content flex-grow-1">
        <div class="container-fluid">
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <div>
                    <button type="button" class="btn btn-success me-2" data-bs-toggle="modal" data-bs-target="#shiftReportModal">
...
<div class="modal fade" id="shiftReportModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Generar Reporte por Jornada</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <div class="mb-3">
                    <label for="shiftDate" class="form-label">Seleccionar Jornada:</label>
                    <input type="date" class="form-control" id="shiftDate">
                </div>
                <div class="alert alert-info">
                    <i class="bi bi-info-circle"></i> Cada jornada comienza a las 8:00 AM y termina a las 8:00 AM del día siguiente.
                </div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancelar</button>
                <button type="button" class="btn btn-primary" id="generateShiftReport">
                    ...
                    if (data.status === 'success') {
                        ...
                        data.items.forEach(item => {
                            ...
                            row.innerHTML = `
                                ...
                                <td>Q${(item.cantidad_vendida * item.precio_unitario).toFixed(2)}</td>
                            `;
...
document.getElementById('generateShiftReport').addEventListener('click', function() {
    const shiftDate = document.getElementById('shiftDate').value;
    
    if (!shiftDate) {
        alert('Por favor seleccione una fecha para la jornada');
        return;
    }
    
    // Abrir reporte en nueva pestaña
    window.open(`get_sale_details.php?shift_report=1&shift_date=${shiftDate}`, '_blank');
